...
$$
\begin{justify}
This is a sample paragraph that demonstrates how to justify text. 
Justified text aligns both the left and right edges, creating a clean and professional look.
\end{justify}
$$
